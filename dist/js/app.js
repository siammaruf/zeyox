...
var _banner = document.getElementById("home-banner");

var _fArea = document.getElementById("home-feature-area");

var _circle = document.getElementById("js-cursor");

var _follower = document.getElementById("js-cursor-follower");

var _mTitle = document.getElementById("site-main-title");

var _rollingTextTop = document.getElementById("rolling-text-first");

var _rollingTextBottom = document.getElementById("rolling-text-last");

function cursorMouse(event) {
  var circleTimeLine = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    defaults: {
      duration: 0.3,
      ease: "none"
    }
...
var _hamburguer = document.getElementById('nav-hamburguer');
...
var bannerScroll = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  scrollTrigger: {
...
var _fProgressBar = document.getElementById("feature-progress-bar");

var _progressBarWrap = document.getElementById("progress-bar-area");

gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(_progressBarWrap, {
  width: screen.width
});
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(_fArea, {
  height: screen.height
});
var fTextScroll = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  scrollTrigger: {
    trigger: _fArea,
    pin: true,
    start: "top top",
  ...
  value: 100,
  ease: 'none'
}, 0); // Animation Text On Load

var mTitleTimeLine = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
mTitleTimeLine.from(".site-main-title > span > span", {
  duration: 0.75,
  y: 150,
  autoAlpha: 0,
  ease: gsap__WEBPACK_IMPORTED_MODULE_2__.Power3.out,
  stagger: 1.5
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkzeyox"] = self["webpackChunkzeyox"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./scripts/app.js")))
